...
import com.shixing.mvp.impl.MainFragment
...
class LoginActivity : AppCompatActivity(), LoaderCallbacks<Cursor> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d(TAG, mainFragment.toString())
        Log.d(TAG, mainFragment.presenter.toString())
        Log.d(TAG, mainFragment.presenter.view.toString())
